...
import com.recordsystem.userservice.util.TestJwtUtil;
...
class UserControllerIntegrationTest {
    ...
    void testGetUserByIdWithValidId_shouldReturnUser() {
        webClient.get()
                ...
                .value(foundUser -> {
                    ...
                    assertThat(foundUser.getCreatedAt()).isEqualTo(user.getCreatedAt().getTime());
                });
    }
    ...
    void testCreateUserWithInvalidRequest_shouldReturn400() {
        ...
        Mono<User> foundUser = userRepository.findByEmail(request.getUsername());
    ...
    void testCreateUserWithValidRequest_shouldCreateUser() {
        ...
        Mono<User> createdUser = userRepository.findByEmail(request.getUsername());
